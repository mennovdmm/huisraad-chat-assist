      ...
      <div className="max-w-4xl mx-auto">
        <div className="relative flex items-end gap-2">
          ...
          <button
            ...
            className="huisraad-send-btn h-[64px] w-10 rounded-lg p-0 flex-shrink-0 shadow-sm transition-all duration-150 border-0 flex items-center justify-center disabled:opacity-50"
            style={{ 
